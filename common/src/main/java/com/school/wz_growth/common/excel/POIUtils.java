...
//		toStyle.setFont(fromStyle.getFont(null));
    ...
    public static void copySheet(XSSFWorkbook wb, XSSFSheet fromSheet, XSSFSheet toSheet,
        ...
        //列宽拷贝
        int  toColumnNum = toSheet.getLastRowNum();
        for (int i = 0; i < toColumnNum; i++)
    ...
    public static void mergerRegion(XSSFSheet fromSheet, XSSFSheet toSheet) {
        ...
        for (int i = 0; i < sheetMergerCount; i++) {
            CellRangeAddress mergedRegionAddress = fromSheet.getMergedRegion(i);
            toSheet.addMergedRegion(mergedRegionAddress);
        }
    }
     ...
     * 复制单元格
     *
     * @param srcCell   来源cell
     * @param distCell  目标cell
     * @param copyValueFlag
     *            true则连同cell的内容一起复制
     */
