...
public class OrgPersonUpdateRequestVo extends BaseRequestVo {
    ...
    public boolean validator() {
        ...
        if(null == id || StringUtils.isBlank(name) || StringUtils.isBlank(tel) || null == org_id ||  null == state ||  null == role_id)
        {
            return  false;
        }
